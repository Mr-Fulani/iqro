...
веб-сайта и Telegram Mini App. Первый вертикальный срез посвящён Корану, аудио, времени
намаза и напоминаниям; архитектура предусматривает отдельные домены дуа, переводов,
тафсиров, карточек заучивания, хадисов, книг и образовательных подборок.
