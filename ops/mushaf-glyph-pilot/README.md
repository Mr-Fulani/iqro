...
Разметка следующей версии v4 использует [единую типографическую сетку](TYPOGRAPHY.md).
Это отдельная версия файлов; наличие исправленного генератора не означает,
что старый скачанный пакет на телефоне уже обновлён.
...
- Один равномерный масштаб глифов на страницу. Начиная с v4, общий шаг базовых
  линий и метрики страницы учитывают огласовки/нижние элементы; свободная высота
  больше не распределяется в зависимости от высоты отдельных строк.
  Для выделения используются области этой же раскладки.
