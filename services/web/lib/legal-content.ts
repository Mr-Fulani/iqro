...
const en = (config: LegalConfig): LegalCopy => {
  return {
    ...
    sources: { title: "Sources and licenses", description: "Provenance, versions, rights holders, and usage terms for published Quran, audio, and dua content.", quranTitle: "Quran editions", audioTitle: "Audio recitations", duaTitle: "Duas and adhkar", duaBody: "The starter catalog is based on the IslamHouse language editions of Hisn al-Muslim. Text and meaning retain their language edition, source identifier, and snapshot version.", duaRights: "IslamHouse terms permit distribution without changing the scholarly content and with source attribution. The team is also seeking written confirmation before publishing the complete catalog as individual cards.", duaVerification: "Hadith references are currently marked as copied from the source edition. Independent editorial verification is shown only after it actually occurs; automated HadeethEnc matching does not count as verification.", version: "Version", source: "Source", license: "License", rightsHolder: "Rights holder", attribution: "Attribution", noQuran: "No published editions.", noAudio: "No published licensed recitations.", noticeTitle: "Important", noticeBody: "Only active versioned material with recorded provenance and licensing is published. Content terms do not automatically apply to the entire software product. Direct media URLs are intentionally omitted from this page." },
  };
};
