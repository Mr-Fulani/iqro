  ...
  return {
    privacy: {
      ...
      sections: [
        ...
        { title: "2. Data we process", paragraphs: ["The data depends on the features you use."], bullets: ["installation and device identifiers, app version, language, time zone, sessions, and security events;", "email and verification state for one-time-code sign-in;", "reading position, daily goal, after-prayer reading plan and check-ins, reading sessions, progress and completed-day streak, bookmarks, reminders, prayer settings, and sync state; when notifications are enabled, the browser push endpoint and public subscription keys; after separate location permission, device coordinates used only to calculate prayer notifications;", "support ticket subject, messages, and history;", "IP address, request ID, and minimal request logs for security, diagnostics, and abuse prevention."] },
