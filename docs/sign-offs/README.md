...
1. Зафиксировать scope и технические риски в
   [fast-track release plan](../release/web-mvp-fast-track-2026-08-25.md).
2. Для Quran dataset создать новый
...
3. Для Quran.Foundation audio отправить
...
4. На каждого активируемого чтеца скопировать и заполнить
   [religious/editorial review](quran-audio-editorial-review-template.md).
5. Product owner подписывает release decision только после зелёного CI/security, monitoring
