...
- [ ] Добавить автоматический зачёт фактического чтения из Flutter reader lifecycle: активное
  время, последовательные страницы/аяты, idempotent delivery и защита от зачёта навигационных
  прыжков.
