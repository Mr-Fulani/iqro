...
только проверенный scan-вариант; web-варианты нельзя
включать в native UI без отдельных page assets, hit maps и offline manifest. Полный плеер
уже переключает вид чтения и чтеца с сохранением текущей суры и безопасным переносом позиции
по совместимым таймкодам. Далее идут backend parity мобильного Плана, расширенные настройки
намаза, управление offline-хранилищем и release/performance hardening.
