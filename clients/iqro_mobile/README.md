...
Приоритет следующего мобильного этапа — Мусхаф и плеер. Сейчас полный плеер ещё не
переключает чтеца внутри самого экрана, а мобильный Мусхаф публикует только проверенный
scan-вариант; web-варианты нельзя включать в native UI без отдельных page assets, hit maps
и offline manifest. После них идут backend parity мобильного Плана, расширенные настройки
