...
1. Завершить связку Мусхаф ↔ аудио: дополнительные проверенные native-варианты Мусхафа,
   навигация по хизбу/рубу без web-обёрток и выбор разрешённого качества аудиодорожки.
