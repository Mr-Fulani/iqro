...
mobile-android-profile-staging:
	cd clients/iqro_mobile && flutter build apk --profile --target-platform android-arm64 --dart-define=API_BASE_URL=https://staging.iqro.forum --dart-define=APP_ENV=staging --dart-define=APP_DOWNLOAD_URL=https://iqro.forum
